	...
	<div class="module dirtyskybluebg main-plan">
		...
		<div class="module-content">
			...
			<ul class="devices">
				...
				<li data-device="smart-phone" data-costper="10" data-num="2">
					<div class="device-img">
				...
				<li data-device="tablet" data-costper="10" data-num="0">
					<div class="device-img">
